...
@section('page-title', 'Hourly Rides')
@section('content')
                                ...
                                <tbody class="form-text-element">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <a href="{{route('admin.complete_pending', ['id' => $item->id, 'type' => 2])}}" class="btn btn-warning btn-xs"><i class="fa fa-inr"></i> Complete Pending</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
