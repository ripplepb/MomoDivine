 ...
 "use strict";
  ...
  function responsive_dropdown () {
    ...
    $('.navbar-toggle').on("click", function(){
        $(this).toggleClass( 'navbar-is-open' );
      var menu_id = $('#menu');
  ...
  function quantityasad(type,input_id,stock) {
    ...
    let qty = $("#productqtytxxt").val();
    console.log(stock);
    console.log(qty);
    if (parseInt(stock) < parseInt(qty)) {
      $("#add_to_cart").html('<b style="color:red;font-weight:700;width:120px;padding: 5px 0;">OUT OF STOCK</b>');
      // console.log('out of stock');
    }else{
      $("#add_to_cart").html('<button type="submit" title="Add to Cart" class="btn-black">Add to Cart</button>');
