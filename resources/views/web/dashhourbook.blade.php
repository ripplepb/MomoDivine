...
<section class="dashboard">
    ...
    <div class="dashboard-area">
        <div class="profilearea">
            ...
            {{-- <div class="logout">
                <p><a href="#"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a></p>
            </div> --}}
        </div>
            ...
            <div class="allbookings">
                @foreach ($details as $item)
                    <div class="individualbookings">
                        ...
                        <p>
                            Time: {{date('g:i a', strtotime($item->time))}}
                        </p>
                        <p>
                            Price: &#8377; {{$item->hour->price}}
                        </p>
                    </div>
                @endforeach
            </div>
